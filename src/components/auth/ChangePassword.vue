  ...
  <form class="row g-3 needs-validation" novalidate @submit.prevent="changePassword">
    ...
    <div class="mb-3">
      <div class="mb-3">
        ...
        <input type="password" class="form-control" id="inputCurrentPassword" required  v-model="passwords.current_password">
    ...
    <div class="mb-3">
      <div class="mb-3">
        ...
        <input type="password" class="form-control" id="inputPasswordConfirm" required v-model="passwords.password_confirmation">
